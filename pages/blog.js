...
const Blog = ({ categories }) => {
  ...
  //   formData.append("category", selectedCategory.id); // Append the selected category ID
      ...
      <div className="flex flex-col mt-10">
        ...
        <div className=" md:flex mt-10">
          ...
          <div>
            <div>
              <div>Category</div>
              <div className="relative flex items-center w-[90vw] md:w-[45vw] h-[45px]">
                {/* <Listbox
...
//!below without customized dropdown, above with custom dropdown
...
//   // const handlePublish = () => {
//   //   // Create a FormData object to store the blog data
//   //   const formData = new FormData();
...
//   //   axios.post(process.env.NEXT_PUBLIC_BLOG, formData)
//   //     .then(response => {
...
//     axios.post(process.env.NEXT_PUBLIC_BLOG, formData)
//       .then(response => {
//         // Assume success if the API call is successful without any specific response
//         setIsPublished(true);
//         setTimeout(() => {
//           setIsPublished(false);
//           handleReset();
