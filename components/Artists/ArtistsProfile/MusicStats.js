...
const MusicStats = ({ dashboardInfo, artist }) => {
  if (!dashboardInfo) {
    return <div>Loading...</div>; // You can replace this with your desired loading state
  }
  // console.log("dashboardInfo :",dashboardInfo)

  const { totalMusic, albums, totalUpcomingMusic, totalPublishedMusic } = dashboardInfo.dashboardInfo;
