        ...
        >
          <div className="flex items-center">
            ...
            <div
              ...
              onClick={() => handleSingleClick(single.artistNumber, single.title)}
            >
              <Image
                src={single.image}
                alt="Single Cover"
            ...
            <div className="ml-4 cursor-pointer" onClick={() => handleSingleClick(single.artistNumber, single.title)}>
          ...
          <div className="flex items-center">
            ...
            <TiDownload className="w-6 h-6 text-white ml-4 cursor-pointer" onClick={handleDownload} />
          </div>
        </label>
      ))}
