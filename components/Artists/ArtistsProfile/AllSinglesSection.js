  ...
  const handleDownloadSelected = async () => {
    try {
      ...
      for (const single of selectedSingles) {
        await handleDownload("https://admin.emergencemusicdistribution.com/uploads/audio/track/1687028749-file.wav");
          ...
          .map((single, index) => (
            ...
            >
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  {isPlaying[index] ? (
                    <TiMediaPause
                      ...
                      onClick={() => handlePlayPause(index, "https://admin.emergencemusicdistribution.com/uploads/audio/track/1687028749-file.wav")}
                    />
                  ) : (
                    <TiMediaPlay
                      className="w-6 h-6 text-white cursor-pointer"
                ...
                <TiDownload
                  className="w-6 h-6 text-white ml-4 cursor-pointer"
                  onClick={() => handleDownload("https://admin.emergencemusicdistribution.com/uploads/audio/track/1687028749-file.wav")}
                />
              </div>
            </label>
          ))}
